...
SECRET_KEY = "django-insecure-$cq0hktslr(dbq$y%bprx=$vr7um237vefz!ft(p!ns2_sa^1o"
...
# Original SQLite database configuration for local development
DATABASES = {
    'default': {
...
# Use PostgreSQL on Heroku by checking if DATABASE_URL is set
